class Stack:
    ...
    def __init__(self):  # 자료를 저장할 공간(배열) myStack을 만듭니다.
        self.myStack = []

    def push(self, n):  # stack에 정수 n을 넣습니다.
